...
import '../data/repositories/supabase_announcement_repository.dart' as _i18;
import '../data/repositories/supabase_auth_repository.dart' as _i13;
import '../data/repositories/supabase_event_repository.dart' as _i22;
import '../data/repositories/supabase_profile_repository.dart' as _i19;
import '../data/repositories/supabase_sponsor_repository.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i18.SupabaseAnnouncementRepository>(() =>
        _i18.SupabaseAnnouncementRepository(gh<_i8.SupabaseAnnouncementApi>()));
    gh.lazySingleton<_i19.SupabaseProfileRepository>(
        () => _i19.SupabaseProfileRepository(gh<_i10.SupabaseProfileApi>()));
    gh.lazySingleton<_i20.SupabaseSponsorRepository>(
        () => _i20.SupabaseSponsorRepository(gh<_i11.SupabaseSponsorApi>()));
    gh.factory<_i21.AnnouncementBloc>(
        () => _i21.AnnouncementBloc(gh<_i18.SupabaseAnnouncementRepository>()));
    gh.lazySingleton<_i22.SupabaseEventRepository>(
        () => _i22.SupabaseEventRepository(gh<_i9.SupabaseEventApi>()));
    gh.factory<_i23.SponsorManagmentBloc>(
        () => _i23.SponsorManagmentBloc(gh<_i20.SupabaseSponsorRepository>()));
    gh.factory<_i24.SponsorFormBloc>(
        () => _i24.SponsorFormBloc(gh<_i20.SupabaseSponsorRepository>()));
    gh.factory<_i25.AnnouncementFormBloc>(() =>
        _i25.AnnouncementFormBloc(gh<_i18.SupabaseAnnouncementRepository>()));
    gh.factory<_i26.EventsManagmentBloc>(
        () => _i26.EventsManagmentBloc(gh<_i22.SupabaseEventRepository>()));
    gh.factory<_i27.AttendeesBloc>(
        () => _i27.AttendeesBloc(gh<_i19.SupabaseProfileRepository>()));
    gh.factory<_i28.ProfileBloc>(
        () => _i28.ProfileBloc(gh<_i19.SupabaseProfileRepository>()));
    gh.factory<_i29.EventFormBloc>(
        () => _i29.EventFormBloc(gh<_i22.SupabaseEventRepository>()));
    return this;
  }
}
