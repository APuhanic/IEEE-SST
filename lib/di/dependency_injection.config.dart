...
import '../data/repositories/supabase_event_repository.dart' as _i4;
import '../data/repositories/supabase_profile_repository.dart' as _i5;
import '../data/router/bloc/navigation_bloc.dart' as _i3;
import '../data/router/navigator_key_manager.dart' as _i8;
import '../data/router/router.dart' as _i15;
import '../data/supabase/supabase_api.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.NavigationBloc>(() => _i3.NavigationBloc());
    gh.lazySingleton<_i4.SupabaseEventRepository>(
        () => _i4.SupabaseEventRepository());
    gh.lazySingleton<_i5.SupabaseProfileRepository>(
        () => _i5.SupabaseProfileRepository());
    ...
    gh.lazySingleton<_i12.SupabaseApi>(
        () => _i12.SupabaseApi(gh<_i6.SupabaseClient>()));
